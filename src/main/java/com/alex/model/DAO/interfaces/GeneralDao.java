...
import com.alex.model.presistent.ConnectionManager;
...
public interface GeneralDao<T,ID> {
    ...
    default int create(T entity) throws SQLException{
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(createElement())){
    ...
    default int update(T entity) throws SQLException{
        Connection connection = ConnectionManager.setConnection();
        try (PreparedStatement preparedStatement = connection.prepareStatement(updateElement())){
            PreparedStatement statement = setParameters(preparedStatement,entity);
    ...
    default int delete(ID id) throws SQLException{
        Connection connection = ConnectionManager.setConnection();
        try (PreparedStatement preparedStatement = connection.prepareStatement(deleteElement())){
            preparedStatement.setObject(1, id);
